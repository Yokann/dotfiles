...
-- User directory
hl.env("XDG_DESKTOP_DIR", HomeDir .. "/Desktop", true)
hl.env("XDG_DOWNLOAD_DIR", HomeDir .. "/Downloads", true)
hl.env("XDG_TEMPLATES_DIR", HomeDir .. "/Templates", true)
hl.env("XDG_PUBLICSHARE_DIR", HomeDir .. "/Public", true)
hl.env("XDG_DOCUMENTS_DIR", HomeDir .. "/Documents", true)
hl.env("XDG_MUSIC_DIR", HomeDir .. "/Music", true)
hl.env("XDG_PICTURES_DIR", HomeDir .. "/Pictures", true)
hl.env("XDG_VIDEOS_DIR", HomeDir .. "/Videos", true)
hl.env("WALLPAPERS_PATH", HomeDir .. "/Pictures/wallpapers", true)
hl.env("HYPRSHOT_DIR", HomeDir .. "/Pictures/Screenshots", true)
