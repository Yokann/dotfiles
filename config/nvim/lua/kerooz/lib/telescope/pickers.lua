-- Comming from  https://github.com/nvim-telescope/telescope.nvim/issues/2014#issuecomment-1732601706
...
-- functionality. It does this by changing the 'display()' function that Telescope uses to display each entry in the Picker.
--
